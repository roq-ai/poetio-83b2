...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'content-creator', 'editor'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Poetries', path: '/poetries', entity: 'poetry', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Shows', path: '/shows', entity: 'show', service: AccessServiceEnum.PROJECT, icon: FiTv },
