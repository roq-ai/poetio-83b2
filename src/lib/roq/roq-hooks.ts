...
export function useContentCreatorFindMany<
...
>(
  ...
  const key = JSON.stringify(['useContentCreatorFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.content_creator.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useContentCreatorCount<T extends Prisma.content_creatorCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.content_creatorCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useContentCreatorCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.content_creator.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useContentCreatorFindManyWithCount<
  T extends Prisma.content_creatorFindManyArgs,
  R extends { data: GetFindResult<Prisma.$content_creatorPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.content_creatorFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useContentCreatorFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.content_creator.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useContentCreatorFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useContentCreatorFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.content_creator.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePoetryFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePoetryFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.poetry.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePoetryCount<T extends Prisma.poetryCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.poetryCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['usePoetryCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.poetry.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePoetryFindManyWithCount<
  T extends Prisma.poetryFindManyArgs,
  R extends { data: GetFindResult<Prisma.$poetryPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.poetryFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePoetryFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.poetry.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePoetryFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePoetryFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.poetry.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
